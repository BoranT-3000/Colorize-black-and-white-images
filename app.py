...
#     st.image(img1, caption='Sharpened image')
...
st.write("Created on 2022 (istanbul) \n @author: Orville")
...
#         'Filter image',
#         ('SHARPEN', 'EDGE ENHANCE','SMOOTH MORE', 
#         'SMOOTH','FIND EDGES','BLUR',
#         'EMBOSS','EDGE ENHANCE MORE','DETAIL','CONTOUR'
#         ))
...
#         sharpen_img(file)
#     elif option == 'EDGE ENHANCE MORE':
#         sharpen_img(file)
#     elif option == 'SMOOTH MORE':
#         sharpen_img(file)
